<?php
function trim_text($theText, $lmt)
{
	// remove tags
	$tagPattern = '~<[^>]*>~';
...
<div class="productview">
    ...
    <?php if( isset($contents) && count($contents)>0 ){
        foreach($contents as $content){ ?>
            <div class="row">
                <div class="col-md-12">
                    <h3><a href="<?php echo $this->Html->url('/pages/view/'.$content['Page']['id']); ?>"><?php echo $content['Page']['title']; ?></a></h3>
                    <?php
                    //echo trim_text( $content['Page']['body'], 100);
