...
Configure::write('SocialMedia.salt', '1234567890');
Configure::write('SocialMedia.facebookAppId', FACEBOOK_APP_ID);

// Datasource v2
//CakePlugin::load('ApiRest');

// Os forms
//CakePlugin::load('OsForms', array('routes' => true));

// Forum frontend logic
CakePlugin::load('Oforum', array('routes' => true, 'bootstrap' => true));
...
// Custom logic
//CakePlugin::load('FIxopress', array('routes' => true));
