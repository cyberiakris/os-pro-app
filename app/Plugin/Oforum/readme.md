...
* v3.x - CakePHP 3.x, PHP 7.0, Composer
* v2.x - CakePHP 2.7, PHP 5.6
* v1.x - CakePHP 2.x, PHP 5.6

## Documentation ##

Thorough documentation can be found here: http://kris.cyberiaweb.net/cake-forum/
